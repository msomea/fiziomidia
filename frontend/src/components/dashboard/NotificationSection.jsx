...
export default function NotificationSection({ notifications, markNotificationRead, userId }) {
  ...
  const notificationLevels = {
    ...
    important: {
      ...
      icon: (
        <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 20 20">
          <path fillRule="evenodd" d="M8.257 3.099c.765-1.276 2.094-1.276 2.094 0s-1.329 1.276-2.094 0C7.492 1.823 6.163 1.823 6.163 3.099s1.329 1.276 2.094 0zm1.532 1.276c-.765 0-1.329.565-1.329 1.276s.564 1.276 1.329 1.276 1.329-.565 1.329-1.276-.564-1.276-1.329-1.276zM1 13a1 1 0 100 2 1 1 0 000-2zm2 0a1 1 0 100 2 1 1 0 000-2zm2 0a1 1 0 100 2 1 1 0 000-2zm2 0a1 1 0 100 2 1 1 0 000-2zm2 0a1 1 0 100 2 1 1 0 000-2zm2 0a1 1 0 100 2 1 1 0 000-2zm2 0a1 1 0 100 2 1 1 0 000-2zm2 0a1 1 0 100 2 1 1 0 000-2zm2 0a1 1 0 100 2 1 1 0 000-2z" clipRule="evenodd"/>
        </svg>
      )
    },
    update: {
